const Css = styled.div`
  ...
  *,
  ...
  .label-grants.proximity .icon-grants {
    background: linear-gradient(45deg, rgba(216, 46, 135, 0.25), rgba(255, 173, 1, 0.25));
    color: #d82e87;
  }
          ...
          <div className="awesome-hero">
            ...
            <div className="hero-content">
              <h1 className="hero-title">
                {project.profile.name} {tokenTicket && <small>({tokenTicket})</small>}{" "}
              </h1>
              ...
              <div className="tile-tags">
                {Object.keys(project.profile.tags).length > 0 &&
                  Object.keys(project.profile.tags).map((e) => {
                    return (
                      <span className="badge rounded-pill bg-secondary text-light" title={e}>
                        {e}
                      </span>
                    );
                  })}
            ...
            <div className="hero-actions">
              <div className="hero-links">
                <div className="btn-group">
                  ...
                  >
                    <i class={isInBookmark(project) ? "bi bi-star-fill" : "bi bi-star"}></i>
                  </a>
