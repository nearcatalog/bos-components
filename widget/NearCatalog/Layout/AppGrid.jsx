const Css = styled.div`
  ...
  .near-item {
    ...
    box-shadow: 0 0.05rem 0.05rem rgba(34, 34, 34, 0.05), 0 0.2rem 0.8rem rgba(34, 34, 34, 0.075);
    border-radius: 0.8rem;
    color: #222;
    display: flex;
    flex-direction: column;
  ...
  .near-item:hover {
    box-shadow: 0 0.1rem 0.2rem rgba(34, 34, 34, 0.05), 0 0.4rem 1.6rem rgba(34, 34, 34, 0.15);
    text-decoration: none;
    ...
    const listItems = [
      ...
      { l: "?cat=community", t: "Community" },
      {
        ...
        menuItems: [
          { l: "?cat=defi", t: "DeFi" },
          { l: "?cat=dex", t: "DEX" },
          { l: "?cat=exchanges", t: "Exchanges" },
          { l: "?cat=launchpads", t: "Launchpads" },
          { l: "?cat=lending", t: "Lending" },
          { l: "?cat=stablecoins", t: "Stablecoins" },
          { l: "?cat=yield_aggregators", t: "Yield Aggregators" },
          { l: "?cat=gaming", t: "Gaming" },
          { l: "?cat=metaverse", t: "Metaverse" },
      ...
      },
      {
        ...
        menuItems: [
          { l: "?cat=dao", t: "DAO" },
          { l: "?cat=regional_hubs", t: "Regional Hubs" },
          { l: "?cat=funding", t: "Funding" },
          { l: "?cat=guilds", t: "Guilds" },
      ...
      { l: "?cat=octopus", t: "Octopus" },
      {
        l: "?cat=infrastructure",
        t: "Infrastructure",
        menuItems: [
          { l: "?cat=wallets", t: "Wallets" },
          { l: "?cat=validators", t: "Validators" },
          { l: "?cat=explorers", t: "Explorers" },
      ...
      },
      {
        ...
        t: "NFT",
        menuItems: [
          { l: "?cat=marketplaces", t: "Marketplaces" },
          { l: "?cat=collectibles", t: "Collectibles" },
        ],
      },
      {
        l: "?cat=utilities",
        t: "Utilities",
        menuItems: [
          { l: "?cat=devtooling", t: "Dev Tooling" },
          { l: "?cat=oracles", t: "Oracles" },
          { l: "?cat=security", t: "Security" },
          { l: "?cat=data", t: "Data" },
          { l: "?cat=analytics", t: "Analytics" },
          { l: "?cat=portfolio", t: "Portfolio" },
          { l: "?cat=on_off_ramps", t: "On/Off Ramps" },
                  ...
                  return (
                    <div className="menu-item">
                      <a
                        ...
                        className={`${
                          (cat == (s.l.length > 0 ? s.l.substring(5) : "") ? " active " : "") +
                          "btn"
                        }`}
                        href={`/${path + (s.l ? s.l : "")}`}
                      >
            ...
            return (
              <div className="menu-parent">
                <a
                  ...
                  preventScrollReset={true}
                  className={`${
                    (cat == (e.l.length > 0 ? e.l.substring(5) : "") ? " active " : "") +
                    "btn btn-lg"
                  }`}
                  href={`/${path + (e.l ? e.l : "")}`}
                >
              ...
              <div className="near-content">
                <div className="near-list-container row">
                  {Object.keys(state.projects).length == 0 && props.bookmark && (
                    <div className="">
                      Nothing here, yet 🙅, press ⭐ in project you want to add!{" "}
                    </div>
                  )}
                  {Object.keys(state.projects).map((e) => {
                    ...
                    return (
                      <div className="near-item-wrap col-md-4 col-sm-12 p-3">
                        <Link className="near-item" title={p.name} href={`/${indexPath}?id=${e}`}>
