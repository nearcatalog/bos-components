        ...
        <div class="d-flex clearfix flex-wrap flex-column flex-sm-row">
          <div class="p-2">
            ...
            <h1>
              ...
              <small
                class={
                  data.body.market_data.price_change_percentage_24h_in_currency.usd < 0
                    ? "text-danger"
                    : "text-success"
                }
                style={{ "font-size": "12px" }}
              >
                {data.body.market_data.price_change_percentage_24h_in_currency.usd.toFixed(2)}%
              </small>
            </h1>
          </div>
          <div class="p-2">
            ATH
            <p class="text-success">${data.body?.market_data?.ath.usd.toFixed(8)}</p>
          </div>
          <div class="p-2">
            24h high
            <p>
